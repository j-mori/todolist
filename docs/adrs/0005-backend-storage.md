# ADR-0005: `node:sqlite` + Kysely for storage
...
## Consequences
- **Positive:** Zero native dependencies (no `node-gyp`, no Alpine compile pain). Kysely gives us inferred query result types end-to-end.
