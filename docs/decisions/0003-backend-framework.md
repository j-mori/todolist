# ADR-0003: Hono as the backend framework
...
- **Follow-up:** Session 3 will define route validators using Hono + Zod; Session 7 may add OpenAPI export via `@hono/zod-openapi` (TBD).
