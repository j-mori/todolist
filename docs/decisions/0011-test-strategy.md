# ADR-0011: Three-layer test strategy — node:test, Vitest, Playwright
...
3. **End-to-end** — **Playwright** (added in Session 6) running specs against the docker-composed stack with seeded data.
...
- **Follow-up:** Session 2 builds the unit suite; Session 3 adds integration; Session 4–5 add component; Session 6 adds E2E.
